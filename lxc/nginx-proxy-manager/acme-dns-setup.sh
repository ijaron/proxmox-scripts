...
wget -q -O tmp.zip https://codeload.github.com/ijaron/nginx-proxy-manager/zip/dns-acme && unzip tmp.zip && rm tmp.zip


cd nginx-proxy-manager-dns-acme
...
# Cleanup
info "Cleaning up..."
rm -rf $_temp_dir/nginx-proxy-manager-dns-acme &>/dev/null
